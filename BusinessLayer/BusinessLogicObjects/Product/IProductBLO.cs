...
namespace Business.LogicObjects.Product
{
    public partial interface IProductBlo : IBaseBlo
    {
        ...
        IEnumerable<Entities.Product.Product> Get(ProductSearchFilter searchFilter);
        ...
        void Update(Entities.Product.Product productDto);
        ...
        Entities.Product.Product Create(Entities.Product.Product productDto);
        ...
        Entities.Product.Product GetById(int id);
